    ...
    <main>
        <section>
            ...
            <form action="atualizar_especie.php" method="post">
                ...
                <input type="number" name="altura_media" id="altura_media" step="0.001" min="0.001" placeholder="Em centímetros" value="<?= htmlspecialchars($especie['altura_media']) ?>" required>
