    ...
    <main>
        <section>
            ...
            <form action="salvar_especie.php" method="post">
                ...
                <input type="number" name="peso_medio" id="peso_medio" step="0.001" min="0.001" required>                

                <label for="altura_media">Altura Média</label>
                <input type="number" name="altura_media" id="altura_media" step="0.001" min="0.001" required>
