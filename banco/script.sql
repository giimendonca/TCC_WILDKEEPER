...
CREATE TABLE
    IF NOT EXISTS classificacao_alimentar (
        id INT PRIMARY KEY AUTO_INCREMENT,
        nome VARCHAR(50) NOT NULL UNIQUE,
        sigla CHAR(2) NOT NULL UNIQUE,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO
    classificacao_alimentar (nome, sigla)
VALUES
    ('Carnívoro', 'CA'),
    ('Herbívoro', 'HE'),
    ('Onívoro', 'ON'),
...
CREATE TABLE
    IF NOT EXISTS medicamentos_consulta (
        id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE
    IF NOT EXISTS historico_habitats (
        id INT PRIMARY KEY AUTO_INCREMENT,
        animal_id INT NOT NULL,
