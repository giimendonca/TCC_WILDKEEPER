...
(id, animal_id, funcionario_id, data_consulta, diagnostico, tratamento, observacoes, data_retorno, instituicao_id)

VALUES

(1, 1, 2, '2026-01-12', 'Avaliação clínica de rotina sem alterações relevantes.', 'Manter rotina alimentar e enriquecimento ambiental.', 'Peso dentro do esperado.', '2026-04-12', 1),

(2, 2, 2, '2026-01-20', 'Boa condição clínica geral.', 'Manter acompanhamento preventivo.', 'Reavaliar peso no próximo trimestre.', '2026-04-20', 1),

(3, 3, 2, '2026-02-05', 'Leve alteração de peso em comparação ao registro anterior.', 'Ajuste da quantidade de alimento conforme protocolo.', 'Nova pesagem recomendada.', '2026-03-05', 1),

(4, 7, 2, '2026-02-18', 'Redução de apetite e comportamento menos ativo.', 'Observação clínica e ajuste alimentar.', 'Animal mantido em observação.', '2026-02-25', 1),

(5, 10, 2, '2026-03-02', 'Adaptação ao recinto em andamento.', 'Manter rotina gradual de adaptação.', 'Monitorar interação com ambiente.', '2026-03-16', 1),

(6, 12, 2, '2026-03-10', 'Desenvolvimento corporal dentro do esperado.', 'Manter alimentação e acompanhamento.', 'Sem alterações importantes.', '2026-06-10', 1),

(7, 18, 7, '2026-01-16', 'Necessidade de acompanhamento preventivo.', 'Cuidados de rotina e observação.', 'Sem sinais de agravamento.', '2026-04-16', 2),

(8, 21, 7, '2026-02-11', 'Alteração articular em acompanhamento.', 'Repouso relativo e tratamento prescrito.', 'Evitar atividades de impacto.', '2026-02-25', 2),

(9, 22, 7, '2026-02-27', 'Boa condição geral com necessidade de enriquecimento ambiental.', 'Manter atividades de enriquecimento.', 'Acompanhar comportamento.', '2026-05-27', 2),

(10, 24, 7, '2026-03-05', 'Animal em recuperação após procedimento.', 'Repouso e acompanhamento clínico.', 'Evolução considerada positiva.', '2026-03-19', 2),

(11, 27, 7, '2026-03-12', 'Recuperação clínica em andamento.', 'Manter protocolo de recuperação.', 'Monitorar alimentação e atividade.', '2026-03-26', 2),
